...
public class Step2 {
    ...
    static void ropes() {// here answer lies early range of answer is like this 11111110000000. because x/1 always possible x/infinity == 0 -> ans < k.
        Scanner sc = new Scanner(System.in);
        int n = sc.nextInt();
        int k = sc.nextInt();
        int[] nums = new int[n];
        ...
        for (int i = 0; i < 100; i++) {// note that we didn't do traditional left pointer goes beyon right then exit loop.
